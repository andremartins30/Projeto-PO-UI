...
import { PoChartType, PoChartOptions, PoChartSerie, PoDialogService, PoChartLabelFormat, PoChartModule, PoPageModule } from '@po-ui/ng-components';

@Component({
  selector: 'app-dashboards',
  templateUrl: './dashboards.component.html',
  providers: [PoDialogService],
  imports: [PoChartModule, PoPageModule],
